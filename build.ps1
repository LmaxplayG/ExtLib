...
function Compile {
    ...
    $MSVCDIR = "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.31.31103\";
    if ($IsWindows) {
        switch($Compiler) {
        0 {
            Write-Host -ForegroundColor Blue "Using GCC on Windows from Chocolatey"
            # Includepath = "C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/"
            C:/ProgramData/Chocolatey/bin/g++.exe -std=c++20 $OOption $WallOption -I"C:/msys64/mingw64/include" -I$IncludePath -o"./output/app.exe" "$LocationPath/src/main.cpp" -static -pthread -g
        }
        1 {
            Write-Host -ForegroundColor Blue "Using Clang"
            C:/"Program Files"/"Microsoft Visual Studio"/"2022"/Community/VC/Tools/Llvm/x64/bin/clang++.exe -masm=intel -std=c++20 $OOption $WallOption  -I"C:/msys64/mingw64/include" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/ucrt" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/winrt" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/cppwinrt" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared" -I$IncludePath -o 'output/app.exe' 'src/**.cpp' 'src/lib/**.cpp' # -g
        }
        2 {
            Write-Host -ForegroundColor Blue "Using MSVC"
            if($O -eq "3") {$O = "2"}
            $OOption = "-O$O"
            & $MSVCDIR/bin/Hostx64/x64/cl.exe -Zi -DDEBUG -Fe:'output/app.exe' -std:c++20 $OOption $WallOption -nologo -I"$MSVCDIR\include" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/ucrt" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/winrt" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared" -I"C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/cppwinrt" 'src/*.cpp' 'src/lib/*.cpp' -EHsc -Fo:"output/" -Fd:"output/app.output.pdb" /link -LIBPATH:'C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.30.30705\lib\x64' -LIBPATH:'C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.30.30705\lib\x64' -LIBPATH:'C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22000.0\um\x64' -LIBPATH:'C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22000.0\ucrt\x64'
        }
        3 {
